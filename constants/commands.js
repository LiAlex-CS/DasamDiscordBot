...
const COMMAND_DESCRIPTIONS = {
  ...
  setSmurf:
    ':pencil2:**setSmurf**: This command sets a new smurf account into the database, type: "$smurf setSmurf `"<player name>"` `<tagline>` `<username>` `"<password>"`". Ex. $smurf setSmurf "nugnug" 6135 AlexUsername "Alex Password123". Please only add valid accounts.',
};
