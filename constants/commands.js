...
const UNKNOWN_COMMAND = 'is a unknown commmand, type: "$smurf help" for a list of all commands or type: "$smurf help <command>" for a description of the command'
 ...
 const COMMAND_ERRORS = {
    ...
    setSmurf: 'are not valid player name and tagline, to set a smurf in the database type: "$smurf setSmurf "<player name>" <tagline> <username> "<password>""',
...
const COMMAND_DESCRIPTIONS = {
    ...
    setSmurf: 'setSmurf: This command sets a new smurf account into the database, type: "$smurf setSmurf "<player name>" <tagline> <username> "<password>"". Ex. $smurf setSmurf "nugnug" 6135 AlexUsername "Alex Password123". Please only add valid accounts.',
}

const SET_SMURF_SUCCESS = 'You have successfully added accound credentials to the database. Please note that this account and its credentials are now accessable to anyone who uses this bot.'

const RANKS_INTRO = "Here is a list of all accounts and their ranks:";

const HAS_SPACES_REMINDER = 'If any arguments have spaces, remeber to add quotation marks around them. Ex. <player name>: "nug nug"'

module.exports = { PREFIX, COMMANDS, ALL_COMMANDS, UNKNOWN_COMMAND, COMMAND_ERRORS, COMMAND_DESCRIPTIONS, RANKS_INTRO, HAS_SPACES_REMINDER, SET_SMURF_SUCCESS }