...
export const UNKNOWN_COMMAND = 'is a unknown commmand, type: "$smurf help" for a list of all commands or type: "$smurf help <command>" for a description of the command'
