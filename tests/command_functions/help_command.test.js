const { help_command } = require("../../command_functions/help_command");
...
describe("Test help command", () => {
  ...
  test("Should message with all bot commands", () => {
    help_command(mockMessage, HELP_COMMAND.command, HELP_COMMAND.no_args);
  ...
  test("Should message with help description", () => {
    help_command(mockMessage, HELP_COMMAND.command, HELP_COMMAND.valid_args);
  ...
  test("Should message with arugment lenght error", () => {
    help_command(mockMessage, HELP_COMMAND.command, HELP_COMMAND.invalid_args);
